...
static const inst_t schedule_1[] {
    {.op=EXE,   .rs1=2},                    // EXE sink.0
    {.op=WU,    .rs1=0},                    // WU  cond[0]
    {.op=EXE,   .rs1=3},                    // EXE sink.1
    {.op=WU,    .rs1=1},                    // WU  cond[1]
    {.op=EXE,   .rs1=4},                    // EXE sink.2
    {.op=ADV,   .rs1=2,     .rs2=5000000},  // ADV sink, 5000000
    {.op=EXE,   .rs1=2},                    // EXE sink.0
    {.op=ADV,   .rs1=2,     .rs2=5000000},  // ADV sink, 5000000
    {.op=WU,    .rs1=2},                    // WU  cond[2] 
    {.op=JUMP,  .rs1=0},                    // JUMP line_0
};

static const inst_t schedule_2[] {
    {.op=EXE,   .rs1=0},                    // EXE  source.0
    {.op=EXE,   .rs1=1},                    // EXE  source2.0
